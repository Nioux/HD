...
Certaines de vos aptitudes liées au ki permettent à votre cible de faire un [jet de sauvegarde](hd_abilities_jets_de_sauvegarde.md) pour résister à leurs effets. Le DD du [jet de sauvegarde](hd_abilities_jets_de_sauvegarde.md) est calculé ainsi : DD de sauvegarde contre le ki = 8 + votre bonus de maîtrise + votre modificateur de [Sagesse](hd_abilities_wisdom.md).
