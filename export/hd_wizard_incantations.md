...
DD d'un [jet de sauvegarde](hd_abilities_jets_de_sauvegarde.md) = 8 + votre bonus de maîtrise + votre modificateur d'[Intelligence](hd_abilities_intelligence.md)

Modificateur de sort de combat = votre bonus de maîtrise + votre modificateur d'[Intelligence](hd_abilities_intelligence.md)
