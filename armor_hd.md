...
- Alias: <!--AltName-->Light Armor (SRD p63)<!--/AltName-->
- Source: <!--Source-->(MDR p223)<!--/Source-->
...
- Alias: <!--AltName-->Medium Armor (SRD p63)<!--/AltName-->
...
- Alias: <!--AltName-->Heavy Armor (SRD p63)<!--/AltName-->
...
- Alias: <!--AltName-->Getting Into and Out of Armor (SRD p64)<!--/AltName-->
- Source: <!--Source-->(MDR p225)<!--/Source-->
